...
URL = ["https://soccer365.ru/competitions/18/results/", "https://soccer365.ru/competitions/17/results/",
       "https://soccer365.ru/competitions/12/results/", "https://soccer365.ru/competitions/16/results/",
       "https://soccer365.ru/competitions/15/results/", "https://soccer365.ru/competitions/596/results/",
       "https://soccer365.ru/competitions/19/results/"]

links = []
games = []
teams = ['ПСЖ', 'Бавария', 'Ливерпуль', 'Аякс', 'Интер', 'Ман', 'Ювентус', 'Милан', 'Челси', 'Аталанта']
...
goals_and_minutes = {75: 0, 76: 0, 77: 0, 78: 0, 79: 0, 80: 0, 81: 0, 82: 0, 83: 0, 84: 0, 85: 0, 86: 0, 87: 0,
                     88: 0, 89: 0}
for game in games:
    if game.home_cards == 0 and game.away_cards == 0 and game.home_team in teams or \
            game.home_cards == 0 and game.away_cards == 0 and game.away_team in teams:
        local_home_score = 0
        local_away_score = 0
